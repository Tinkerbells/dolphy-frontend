...
import { deckDetailPageRoute, decksPageRoute, signInPageRoute, signUpPageRoute, studyPageRoute } from '@/features'
...
const browserRouter = createBrowserRouter([
  {
    ...
    children: [
      ...
      },
      {
        ...
        children: [decksPageRoute, deckDetailPageRoute, studyPageRoute],
      },
